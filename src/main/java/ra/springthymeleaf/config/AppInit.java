...
@EnableJpaRepositories("ra.springthymeleaf.repository")
...
public class AppInit implements WebMvcConfigurer, ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ra.springthymeleaf.model.entity");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/jpa?createDatabaseIfNotExist=true");
